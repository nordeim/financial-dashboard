...
| Unit suite | 270 tests / 13 files | Vitest 5 (node env) | `src/lib/__tests__/` |
...
| `src/lib/__tests__/functional-parity.test.ts` | ~527 | Round-9 functional source contracts (ADR-022) + round-10 theme-lifecycle contracts (ADR-023) + round-11 interactive-state contracts (ADR-024) |
