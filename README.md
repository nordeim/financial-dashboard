...
The parity program is at 22 remediation rounds (the round-22 plan: `docs/plans/2026-09-22-parity-remediation-round22.md` — the full-stack verification round: the live re-probe found zero drift for the fourth consecutive round, with the mobile navigation menu verified working on both sides in dev and production, the Tailwind v4 audit clean, and every gate green on a fresh environment — no code changes required; the round-21 plan: `docs/plans/2026-09-22-parity-remediation-round21.md` — the database-path contract round).
